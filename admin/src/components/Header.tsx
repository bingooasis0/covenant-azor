...
export default function Header(){
  ...
  return (<div className="header-bar"><div className="wrapper w-full flex items-center justify-between">
    <div className="flex items-center gap-2"><span className="text-sm opacity-80">Powered by</span>
