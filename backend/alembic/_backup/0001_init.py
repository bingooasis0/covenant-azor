...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('role', sa.String(), server_default=sa.text("'AZOR'"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('estimated_commission', sa.Numeric(12,2), server_default='0'),
        sa.Column('commission_paid', sa.Numeric(12,2), server_default='0')
    )
