          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-200">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Our partner success team is here to support you every step of the way. Whether you have
                questions about our services, need marketing materials, or want to discuss a specific opportunity.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white text-blue-600 rounded-lg border-2 border-blue-600 hover:bg-blue-50 transition-colors font-medium"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
